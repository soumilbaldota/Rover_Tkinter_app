...
button3=tk.Button(text='v',command=move_right,height=3,width=10,bg="gray48")
button3.place(x=80,y=665)

button4=tk.Button(text='>',command=move_back,height=3,width=10,bg="gray48")
...
button6=tk.Button(text='Start',command=startrover,height=3,width=10,bg='green3')
...
t1=threading.Thread(target=speed)
t1.start()
